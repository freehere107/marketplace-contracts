...
export default class Methods {
    ...
    */
    "setTimestamp"(timestamp: (number | string | BN), __options: GasLimit): import("@polkadot/api-base/types").SubmittableExtrinsic<"promise", import("@polkadot/types/types").ISubmittableResult>;
    /**
     * addTimestamp
     *
     * @param { (number | string | BN) } delta,
    */
    "addTimestamp"(delta: (number | string | BN), __options: GasLimit): import("@polkadot/api-base/types").SubmittableExtrinsic<"promise", import("@polkadot/types/types").ISubmittableResult>;
    /**
     * buyNft
     *
