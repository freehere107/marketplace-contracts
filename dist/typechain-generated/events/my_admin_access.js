...
class EventsClass {
    ...
    subscribeOnAdminAddedEvent(callback) {
        const callbackWrapper = (args, event) => {
            ...
            callback((0, typechain_types_1.handleEventReturn)(_event, (0, utils_1.getEventTypeDescription)('AdminAdded', my_admin_access_json_1.default)));
        };
    ...
    subscribeOnAdminRemovedEvent(callback) {
        const callbackWrapper = (args, event) => {
            ...
            callback((0, typechain_types_1.handleEventReturn)(_event, (0, utils_1.getEventTypeDescription)('AdminRemoved', my_admin_access_json_1.default)));
        };
