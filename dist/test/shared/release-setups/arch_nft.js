...
async function setupArchNFT() {
    ...
    const { address } = await constructors.new(100, exports.COLLECTION_NAME, exports.COLLECTION_URI, exports.ADDITIONAL_INFO, { gasLimit: (0, shared_1.gasLimit)(2007404373, 30000) });
